...
public sealed class BrandController : ControllerBase
{
    ...
    /// <summary>Cập nhật brand của Host đang đăng nhập (mỗi Host một brand).</summary>
    [HttpPut]
    public async Task<IActionResult> UpdateBrand([FromBody] BrandRequest request, CancellationToken ct)
    {
